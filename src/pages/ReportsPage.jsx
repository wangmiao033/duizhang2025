...
function ReportsPage({ section }) {
  ...
  if (section === VIEWS.REPORTS_IMPORT) {
    return (
      <PageContainer title={titles[section]} description="从 Excel 导入研发对账记录（沿用原组件）">
  ...
  if (section === VIEWS.REPORTS_STATS) {
    return (
      <PageContainer title={titles[section]} description="图表与报表">
  ...
  if (section === VIEWS.REPORTS_PROFIT) {
    return (
      <PageContainer title={titles[section]} description="项目利润（含渠道）">
  ...
  return (
    ...
    >
      <div className="export-center-panel">
